...
CAN_LOG = correct_type(get_config_value(CONFIG, "can_log", ConfigCategory.OTHER.value), bool, True)
YDL_OPTIONS = correct_type(get_config_value(CONFIG, ConfigCategory.YT_DLP.value), dict, get_default_yt_dlp_config_data())
COMMAND_PREFIX = correct_type(get_config_value(CONFIG, "command_prefix", ConfigCategory.OTHER.value), str, "?")
...
MAX_QUERY_LIMIT = correct_type(get_config_value(CONFIG, "max_query_limit", ConfigCategory.LIMITS.value), int, 25)
MAX_PLAYLIST_LIMIT = correct_type(get_config_value(CONFIG, "max_playlist_limit", ConfigCategory.LIMITS.value), int, 10)
MAX_PLAYLIST_TRACK_LIMIT = correct_type(get_config_value(CONFIG, "max_playlist_track_limit", ConfigCategory.LIMITS.value), int, 100)
MAX_ITEM_NAME_LENGTH = correct_type(get_config_value(CONFIG, "max_name_length", ConfigCategory.LIMITS.value), int, 50)
