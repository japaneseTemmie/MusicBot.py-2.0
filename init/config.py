...
# Config manipulation
def _add_to_config(data: dict[str, Any], defaults: dict[str, Any]) -> None:
...
def ensure_config(path: str, default_data: dict[str, Any]) -> dict[str, Any] | None:
    ...
    if not exists(path):
        ...
        return deepcopy(default_data) # Reading the JSON and going through the check routine again despite already knowing the data is slightly inefficient
