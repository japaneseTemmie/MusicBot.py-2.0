# This project is now partially maintained due to the enshittification of Discord.
...
![Python](https://img.shields.io/badge/python-3.10%2B-blue?logo=python&logoColor=yellow&style=for-the-badge)
...
- [Full Bot Setup Guide](#full-bot-setup-guide)
...
- To ensure YouTube extraction works consistently, a JavaScript runtime may be needed. Please see [yt-dlp's guide](https://github.com/yt-dlp/yt-dlp/wiki/EJS) on how to set it up.
  ...
  2. If your repositories provide a version of the chosen runtime that's too old to meet yt-dlp's requirements (or you're on Windows), download a precompiled binary and set the following flag in `yt_dlp_options`:
